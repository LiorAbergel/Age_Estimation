"""
Experiment 03: CNN with 5-Fold Stratified Group Cross-Validation (Full Run)
...
def build_cnn_model(base_model_fn, input_shape=(400, 400, 3), dropout_rate=0.5):
...
def run_cv(df_full, base_model_fn, model_name, n_splits=5):
    ...
    for fold, (train_idx, val_idx) in enumerate(splits, start=1):
        ...
        if os.path.exists(done_path) and os.path.exists(save_path):
            ...
            model = build_cnn_model(base_model_fn, input_shape=(*CONFIG["PATCH_SIZE"], 3))
