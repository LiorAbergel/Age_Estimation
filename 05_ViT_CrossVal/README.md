...
| `results/results.md` | New (pipeline-aligned) results with Min Error |
| `results/original_results.md` | Original paper results (Table 2, middle section) |
...
Best individual model: **MobileViT-XXS** (MAE 4.69 +/- 0.22) after pipeline
correction, improved from 6.00 in the original paper. See
`results/results_comparison.md` for the full comparison.
