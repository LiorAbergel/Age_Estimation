...
# File layout on the record: {model}_fold{fold:02d}_best_model.keras (zero-padded, e.g. fold01)
ZENODO_RECORD_ID = os.environ.get("HHD_AGE_VIT_CV_ZENODO_RECORD", "21244620")
WEIGHT_MD5 = {
    "ConvNeXtV2_Tiny_fold01_best_model.keras": "dbbbeb15836d6d0246696135cfa36f66",
    "ConvNeXtV2_Tiny_fold02_best_model.keras": "f3c05a89099ca0a51884f63b1f70d131",
    "ConvNeXtV2_Tiny_fold03_best_model.keras": "b973a8dbb157867a8889088a18437c6d",
    "ConvNeXtV2_Tiny_fold04_best_model.keras": "89d66a22cfb922f7d5b2d9120983b84a",
    "ConvNeXtV2_Tiny_fold05_best_model.keras": "403603be669bbdbf7c7e0273f2d6eb31",
    "MobileViT_XXS_fold01_best_model.keras": "f04080e02dde3aad6cdb86c495d6026e",
    "MobileViT_XXS_fold02_best_model.keras": "768dd9cb5b04268ab97eeaaf1e2072c4",
    "MobileViT_XXS_fold03_best_model.keras": "c26b4ea80a1a02d205f96b58e72d0a2f",
    "MobileViT_XXS_fold04_best_model.keras": "22416abedb70e0bc88604cecbb59ba29",
    "MobileViT_XXS_fold05_best_model.keras": "e6157bfd97fa451120e431123e6d413b",
    "SwinV2_Tiny_fold01_best_model.keras": "c3962995a50f868365b939758995f8e5",
    "SwinV2_Tiny_fold02_best_model.keras": "2209bbc2cf09bf59a599380e9294ebd1",
    "SwinV2_Tiny_fold03_best_model.keras": "0e8684dab97b4005d705c4911e18d648",
    "SwinV2_Tiny_fold04_best_model.keras": "b06a191f12e58420f39b10f3a42d1113",
    "SwinV2_Tiny_fold05_best_model.keras": "784c5c1920df3e311cef0b7a852689f1",
    "TinyViT_11M_fold01_best_model.keras": "fa69d3b79f7daec48b0e9ba5c8627f5a",
    "TinyViT_11M_fold02_best_model.keras": "c1df26409c1212b797f4cf0059a64f08",
    "TinyViT_11M_fold03_best_model.keras": "58ca0c1754cdbbd6d97381ede2a92fe8",
    "TinyViT_11M_fold04_best_model.keras": "01ecfeb0c8bca229dca60bfb0c5c262d",
    "TinyViT_11M_fold05_best_model.keras": "8f12c45a21b98aa6893396f6fad973c2",
}
...
def ensure_weights(weights_dir) -> Path:
    ...
    expected = [(m, f, f"{m}_fold{f:02d}_best_model.keras")
...
def run_full_oof(labels_df, data_dir, weights_dir) -> pd.DataFrame:
    ...
    import keras_cv_attention_models  # noqa: F401  (registers custom ViT layers/activations)
    ...
    for model_name in MODEL_NAMES:
        ...
        for fold, (_, val_idx) in enumerate(splits, start=1):
            ckpt = Path(weights_dir) / model_name / f"{model_name}_fold{fold:02d}_best_model.keras"
            if not ckpt.is_file():
