...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--vit-test-preds", type=Path, default=root / "04_ViT" / "predictions" / "test_image_predictions.csv")
    parser.add_argument("--vit-val-preds", type=Path, default=root / "04_ViT" / "predictions" / "val_image_predictions.csv")
